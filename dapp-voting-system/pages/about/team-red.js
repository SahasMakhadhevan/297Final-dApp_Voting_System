        ...
        <div className={styles.main}>
            ...
            <div className="container-fluid text-center">
                <div className="jumbotron">
                    <br />
                    <h1 className="text-center">Team Red</h1>
                    <br />
                    <p>Advanced Micro Devices, Inc., commonly abbreviated as AMD, is an American multinational semiconductor company based in Santa Clara, California, that develops computer processors and related technologies for business and consumer markets.</p>
                </div>
            </div>
        </div>
    )
